...
var file_wallet_v1_wallet_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x75, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x75,
	...
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x42, 0x9b, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x61,
...
var file_wallet_v1_wallet_proto_goTypes = []interface{}{
	...
	(*Transaction)(nil),      // 2: wallet.v1.Transaction
}
var file_wallet_v1_wallet_proto_depIdxs = []int32{
	2, // 0: wallet.v1.MyWalletResponse.transactions:type_name -> wallet.v1.Transaction
	0, // 1: wallet.v1.WalletService.MyWallet:input_type -> wallet.v1.MyWalletRequest
	1, // 2: wallet.v1.WalletService.MyWallet:output_type -> wallet.v1.MyWalletResponse
